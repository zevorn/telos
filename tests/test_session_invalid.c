...
static uint64_t drive_to_response(
    struct telos_session_machine *machine,
    const struct telos_value *payload
)
{
...
static struct telos_session_machine *completed_machine(
    const struct telos_value *payload
)
{
...
static struct telos_session_machine *cancelled_machine(
    const struct telos_value *payload
)
{
    struct telos_session_machine *machine = telos_session_machine_create(NULL);
...
static struct telos_session_machine *failed_machine(
    const struct telos_value *payload
)
{
    struct telos_session_machine *machine = telos_session_machine_create(NULL);
